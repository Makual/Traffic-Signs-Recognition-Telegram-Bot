...
dct_2 = {'1_1': 'Железнодорожный переезд со шлагбаумом',
 ...
 '5_13_1': '5.13.2. Выезд на дорогу с полосой для маршрутных транспортных средств',
 ...
 '5_7_1': '5.7.2. Выезд на дорогу с односторонним движением.',
...
def start(message): # Название функции не играет никакой роли
    if message.text=='/start':
        bot.send_message(message.chat.id, 'Здравствуйте, вы можете загрузить изображение дорожного знака для его классификации.')
